...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            //center the portal
            if (window.parent.$('#postWrapper').length > 0) {
                window.parent.showWrapper();
            } else {

                window.parent.$('body').wrapInner('<div id="postWrapper" style="position: relative; width: 808px; margin: 0 auto;" />');
                window.parent.showWrapper();
            }
        });
    </script>
