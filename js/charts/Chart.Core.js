...
(function(){
	...
	Chart.Arc = Chart.Element.extend({
		...
		draw : function(animationPercent){
			...
			// console.log('drawing arc, animationPercent: '+animationPercent)
			...
			// console.log('set fill color: '+this.fillColor);
			ctx.fillStyle = this.fillColor;
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		calculateCenterOffset: function(value){
			// console.log('this.maxPercentage: ' + this.maxPercentage)
			// Take into account half font size + the yPadding of the top value
			var scalingFactor = this.drawingArea / (this.valuesAsPercent ? 100 : this.max - this.min);
