<mobile-complianceProgressWheel>
	...
	<div class="progress-wheel-container columns medium-5">
        ...
        <div class="columns medium-7">
            <ul class="enhance list indSP" data-collection="assignments" data-subset="skillprofile" data-tags="compliance" data-orderascending="torder" data-rule="exclusive" data-template='{"activities":"#activity_tmpl", "skillprofiles":"#onboarding_skillprofile_tmpl", "dflt":"#default_tmpl", "unassigned":"#catalog_tmpl"}'>  
	...
	<!-- Style  please see progress-wheel.less -->
